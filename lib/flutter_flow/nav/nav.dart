        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'UserScanLogo',
              path: 'UserScanLogo',
              builder: (context, params) => UserScanLogoWidget(),
            ),
            FFRoute(
              name: 'brandinfo',
              path: 'brandinfo',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'brandinfo')
                  : BrandinfoWidget(),
            ),
            FFRoute(
              name: 'emailme',
              path: 'emailme',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'emailme')
                  : EmailmeWidget(),
            ),
            FFRoute(
              name: 'chat',
            ...
            FFRoute(
              ...
              path: 'AdminUploadLogo',
              builder: (context, params) => AdminUploadLogoWidget(),
            ),
            FFRoute(
              name: 'ScanLogo',
              path: 'ScanLogo',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'ScanLogo')
                  : ScanLogoWidget(),
            ),
            FFRoute(
              name: 'AdminLogin',
